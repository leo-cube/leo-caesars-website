...
const Button = React.forwardRef(({
    ...
    const variantClasses = {
        ...
        'coming-soon': 'bg-gradient-to-r from-orange-400 to-pink-400 text-white hover:from-orange-500 hover:to-pink-500 disabled:opacity-60 disabled:cursor-not-allowed',
    };
